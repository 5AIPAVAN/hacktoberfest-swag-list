...
- **Swag**: special AntennaPod stickers
- **Requirements**:
    - Sign up for Hacktoberfest on the official site.
    - Find issues labeled "Good first issue" on AntennaPod's GitHub repository.
    - Leave a comment indicating you’ll be working on the issue.
- **How to sign up**: No special signup known; just register on the Hacktoberfest site.
- **Issues**: Look for issues here [Github Project Board](https://github.com/AntennaPod/AntennaPod/issues).
- **Notes**: Low-code and non-code contributions are welcome. Check the [Contribute page](https://antennapod.org/contribute/) for more details..
